            ...
            <div class="w-full lg:w-[500px]">
                <form action="{{route('users.store')}}" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" placeholder="info@xyz.com" name="email" id="email" value="{{old('email')}}"
                    ...
                    <div class="mb-3">
                        ...
                        <div class="relative">
                            <input type="password" name="password" id="password" value="{{old('password')}}" placeholder="xxxxxxx"
                                class="w-full block rounded border-[#344EAF] bg-transparent focus:ring-[#344EAF] mt-1">
