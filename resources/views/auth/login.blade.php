...
<x-guest-layout>
    ...
    <p class="text-center text-[16px] mb-3">
        Kindly read our <a href="{{url('privacy-policy')}}" class="text-[#173F74] font-bold hover:underline">privacy policy</a>.
    </p>
    ...
    <form method="POST" action="{{ route('login') }}" class="mt-4">
        ...
        <div>
            ...
            <div class="relative flex items-center">
                <x-text-input type="email" placeholder="info@xyz.com" name="email" id="email"
        ...
        <div class="mt-3">
            ...
            <div class="relative">
                <x-text-input type="password" placeholder="xxxxxxxx" name="password" id="password" required
    ...
    <p class="text-[16px] font-normal text-center mt-5">
        Don’t have an account? <a href="{{ route('register') }}" class=" hover:underline font-bold">Sign Up</a>
    </p>
</x-guest-layout>
