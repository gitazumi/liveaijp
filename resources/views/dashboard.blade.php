...
<x-app-layout>
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-5 gap-y-8">
        <div class="relative bg-white hover:bg-[#80C5FF] text-[#173F74] hover:text-white rounded-2xl h-[220px] p-5">
            ...
            <a href="{{ route('information.create') }}" class="absolute bottom-[10px] font-semibold flex items-center">
                <span class="mr-3">
                    Configure
                </span>
        ...
        <div class="relative bg-white hover:bg-[#80C5FF] text-[#173F74] hover:text-white rounded-2xl h-[220px] p-5">
            ...
            <a href="{{ route('faq.index') }}" class="absolute bottom-[10px] font-semibold flex items-center">
                <span class="mr-3">
                    Configure FAQ’s
                </span>
                <svg width="30" height="25" viewBox="0 0 24 24" fill="currentColor"
        ...
        <div class="relative bg-white hover:bg-[#80C5FF] text-[#173F74] hover:text-white rounded-2xl h-[220px] p-5">
            ...
            {{-- @if ($calendar && $calendar->status != 'active')
                <small class="text-red-500">
                    {{ $calendar->error_message ?? 'Something went wrong while processing google calendar configuration.' }}
                </small>
            @else
                <a href="{{ route('google-calendar.events') }}" class="hover:underline hidden">My Events</a>
            @endif --}}
        ...
        <div class="relative bg-white hover:bg-[#80C5FF] text-[#173F74] hover:text-white rounded-2xl h-[220px] p-5">
            ...
            <a href="{{ route('chat.history') }}" class="absolute bottom-[10px] font-semibold flex items-center">
                <span class="mr-3">
                    View All
                </span>
                <svg width="30" height="25" viewBox="0 0 24 24" fill="currentColor"
        ...
        <div class="relative bg-white hover:bg-[#80C5FF] text-[#173F74] hover:text-white rounded-2xl h-[220px] p-5">
            ...
            <a href="{{url('chat/generate-snippet')}}" class="absolute bottom-[10px] font-semibold flex items-center">
                <span class="mr-3">
                    Generate Code
                </span>
                <svg width="30" height="25" viewBox="0 0 24 24" fill="currentColor"
        ...
        <div class="relative bg-white hover:bg-[#80C5FF] text-[#173F74] hover:text-white rounded-2xl h-[220px] p-5">
            ...
            <a href="{{ route('chat.bot') }}" class="absolute bottom-[10px] font-semibold flex items-center">
                <span class="mr-3">
                    Test
                </span>
                <svg width="30" height="25" viewBox="0 0 24 24" fill="currentColor"
    ...
    @push('script')
        <script>
            $('#generate-snippet').click(function(e) {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{ route('chat.generate-snippet') }}",
                    headers: {
