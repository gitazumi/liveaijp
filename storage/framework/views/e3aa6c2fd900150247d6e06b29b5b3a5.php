<?php $__env->startSection('title', 'Login into your account'); ?>
...
<?php $component->withAttributes([]); ?>
    <div class="flex justify-center items-center">
        <img src="<?php echo e(asset('logo.png')); ?>" alt="" srcset="">
    </div>
    <p class="font-semibold text-center text-[16px] mt-3">
        Login into your account
    </p>
    <p class="text-center text-[16px] mb-3">
        Kindly read our <a href="<?php echo e(url('privacy-policy')); ?>" class="text-[#173F74] font-bold hover:underline">privacy policy</a>.
    </p>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['type' => 'email','placeholder' => 'info@xyz.com','name' => 'email','id' => 'email','value' => ''.e(old('email')).'','class' => 'pr-[45px]','required' => true,'autofocus' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'email','placeholder' => 'info@xyz.com','name' => 'email','id' => 'email','value' => ''.e(old('email')).'','class' => 'pr-[45px]','required' => true,'autofocus' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
            <div class="relative">
                <?php if (isset($component)) { $__componentOriginal18c21970322f9e5c938bc954620c12bb = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal18c21970322f9e5c938bc954620c12bb = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['type' => 'password','placeholder' => 'xxxxxxxx','name' => 'password','id' => 'password','required' => true,'autocomplete' => 'current-password']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('text-input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'password','placeholder' => 'xxxxxxxx','name' => 'password','id' => 'password','required' => true,'autocomplete' => 'current-password']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal18c21970322f9e5c938bc954620c12bb)): ?>
<?php $attributes = $__attributesOriginal18c21970322f9e5c938bc954620c12bb; ?>
        ...
        <div class="flex justify-between mt-4">
            ...
            <div>
                <?php if(Route::has('password.request')): ?>
                    <a class="block text-white hover:underline text-[14px]"
...
<?php endif; ?>
        ...
        <div class="flex items-center justify-between space-x-4 my-5">
            ...
            <span class="text-[#173F74] text-[14.14px]">OR</span>
            <hr class="flex-grow border-t border-[#173F74]">
        </div>
    ...
    <p class="text-[16px] font-normal text-center mt-5">
        Don’t have an account? <a href="<?php echo e(route('register')); ?>" class=" hover:underline font-bold">Sign Up</a>
    </p>
 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
