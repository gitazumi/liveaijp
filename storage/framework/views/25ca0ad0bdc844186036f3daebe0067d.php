    ...
    <div class="flex justify-center h-screen overflow-y-hidden">
        <div class="h-[90%]  w-full rounded-xl p-[30px] sm:p-[50px] bg-[#E9F2FF]">
            <div class="flex items-center">
                <a href="<?php echo e(route('chat.history')); ?>">
            ...
            <div id="message-list" class="max-h-[90%] overflow-y-auto w-full">
                ...
                <div class="flex-1 overflow-y-auto p-1 sm:p-3 mb-2">
                    <?php $__empty_1 = true; $__currentLoopData = $chats->messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <?php if($chat->send_by): ?>
                            <div class="flex mb-5">
                                <div class="mr-2">
                                ...
                                <div
                                    ...
                                    <small class="text-16px absolute bottom-[2px]">
                                        <?php echo e(date('Y-m-d H:i', strtotime($chat->created_at))); ?>
...
<?php endif; ?>
<?php /**PATH /var/www/resources/views/admin/chat/chat.blade.php ENDPATH**/ ?>