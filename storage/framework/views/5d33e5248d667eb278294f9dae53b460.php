            ...
            <tbody id="myTable">
                <?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        ...
                        <td class="py-5 px-3">
                            <span class="bg-[#173F74] text-white rounded p-1 px-3"><?php echo e($user->status); ?></span>
                        </td>
                        <td>
                            <p class="flex justify-center">
                                <a href="<?php echo e(url('users/auto-login/' . $user->id)); ?>">
                                ...
                                <a href="<?php echo e(route('users.edit', ['id' => $user])); ?>" class="mx-2">
                                ...
                                <a href="#" class="delete-modal mx-2" data-id="<?php echo e($user->id); ?>">
                                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
    ...
    <?php $__env->startPush('script'); ?>
        <script>
            $('.delete-modal').click(function(e) {
                ...
                let id = $(this).data('id');
                // let url = `/users/${id}`;
                let url = "<?php echo e(url('/users/')); ?>" + '/' + id;
